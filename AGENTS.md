# derecho — instrucciones para Codex

## Triggers — cuando aplicar estas instrucciones

Aplicar cuando el usuario mencione: mis derechos, cómo reclamar, qué dice la ley, despido, indemnización, consumidor, contrato, sociedad, SAS, SRL, legislación argentina, código civil, LCT.
